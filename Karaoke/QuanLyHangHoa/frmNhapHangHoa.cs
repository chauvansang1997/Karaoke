...
namespace Karaoke.QuanLyHangHoa
{
    ...
    public partial class frmNhapHangHoa : Form
    {
        public frmNhapHangHoa(string nhaCungCap)
        {
            this.nhaCungCap = nhaCungCap;
            InitializeComponent();
        }
        public frmNhapHangHoa(string nhaCungCap,string phieuDatHang)
        {
            this.nhaCungCap = nhaCungCap;
...
>>>>>>> 684ccd889c3e5ec955668cac43100cb4812b2990
        ...
        private void hienThiDanhSachHangHoa()
        {
            ...
            {
                listHangHoa = BUS.SanPhamBUS.XemSanPham(nhaCungCap,loaiHienTai, pageNumber, pageSize);
                listFoodLayout = new List<FoodLayout>();
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (BUS.SanPhamBUS.NhapHangSanPham(soHoaDon,maSanPham, soluongSanPham, TongCong))
            {
        ...
        private void tabControl_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (tabPage != null)
            {
                loaiHienTai = tabControl.SelectedIndex;
